...
class HttpResponse {
  ...
  public static get<TData>(
    ...
    const message = 'successfully received data'
  ...
  public static created<TData>(
    ...
    // const i18nOpt: string | TOptions = { lng: options?.lang }
    const message = 'successfully added data'
  ...
  public static updated<TData>(
    ...
    // const i18nOpt: string | TOptions = { lng: options?.lang }
    const message = 'successfully updated data'
  ...
  public static deleted<TData>(
    ...
    // const i18nOpt: string | TOptions = { lng: options?.lang }
    const message = 'successfully deleted data'
